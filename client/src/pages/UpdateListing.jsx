...
export const UpdateListing = () => {
  ...
  useEffect(() => {
    const fetchListing = async () => {
      //  useparams se utiliza para crear y acceder a múltiples parámetros de un sitio web,y le pasamos el parametro que tiene la ruta en la app.jsx
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ESTE PARAMS.LISTINGID es del use params, y que el listingID lo sacamos de la ruta /update-listing/:listingID en app.jsx que es el id de la publicacion que queremos editar
      ...
      */}
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex flex-col flex-1">
          ...
          >
            {loading ? "Editando ..." : "Editar publicacion"}
          </button>
